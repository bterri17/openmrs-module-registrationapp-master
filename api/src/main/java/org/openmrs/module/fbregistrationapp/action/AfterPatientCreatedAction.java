package org.openmrs.module.fbregistrationapp.action;
...
/**
 * An action that can be configured to run after creating a patient, for a particular instance of the fb_registration app
 */
