package org.openmrs.module.fbregistrationapp;
...
public class RegistrationAppUtilsComponentTest extends BaseModuleContextSensitiveTest {
    ...
    public void getConcept_shouldFindAConceptByStaticConstant() throws Exception {
        assertThat(RegistrationAppUtils.getConcept("org.openmrs.module.fbregistrationapp.RegistrationAppUtilsComponentTest.TEST_CONCEPT_CONSTANT_ID", conceptService), notNullValue());
        assertThat(RegistrationAppUtils.getConcept("org.openmrs.module.fbregistrationapp.RegistrationAppUtilsComponentTest.TEST_CONCEPT_CONSTANT_UUID", conceptService), notNullValue());
        assertThat(RegistrationAppUtils.getConcept("org.openmrs.module.fbregistrationapp.RegistrationAppUtilsComponentTest.TEST_CONCEPT_CONSTANT_MAPPING", conceptService), notNullValue());
    }
