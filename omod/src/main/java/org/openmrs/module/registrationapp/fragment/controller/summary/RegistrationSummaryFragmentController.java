package org.openmrs.module.fbregistrationapp.fragment.controller.summary;
...
public class RegistrationSummaryFragmentController {
    ...
    public void controller(FragmentConfiguration config,
                           ...
                           @RequestParam(value = "search", required = false) String search, // context for going back to fb_registration landing page
